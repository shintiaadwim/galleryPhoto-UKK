            ...
            <form class="space-y-6" action="loginproses" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="email"
                        class="lowercase border rounded-lg block w-full p-2.5 sm:text-sm" placeholder="your@email.com">
                </div>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                    <input type="password" name="password" class="rounded-lg block w-full p-2.5 sm:text-sm"
